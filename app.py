...
# Condition labels (must match the model's training class order)
CONDITION_LABELS = [
...
def display_sidebar():
    ...
    with st.sidebar:
        ...
        st.header("🔗 Resources")
        st.markdown("- [GitHub Repository](https://github.com/ronni86bit/dermarag)")
...
def main():
    ...
    if analyze_button and uploaded_files:
        try:
            ...
            # Log the image paths for prediction
            print(f"Prediction started for images: {temp_paths}")
            # Get predictions
            ...
            if index_exists:
                ...
                # Write the explanation (allows markdown from LLM, but no unsafe HTML)
